...
date: 2020-09-15
canonicalUrl: https://tlundberg.com/blog/2020-09-15-redwood-pagination-tutorial
...
This tutorial will show you one way to implement pagination in an app built using RedwoodJS. It builds ontop of [the official RedwoodJS tutorial](https://cedarjs.com/docs/8.x/tutorial/foreword) and I'll assume you have a folder with the code from the tutorial that you can continue working on. (If you don't, you can clone this repo: https://github.com/thedavidprice/redwood-tutorial-test)

![Screenshot of pagination](/assets/redwood_pagination.png "pagination screenshot")
